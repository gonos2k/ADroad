...
- diag_steps_rate — **lead(primary gate)**: bg 0.0000 / da 0.0000  ·  **window(report-only)**: bg 0.0417 / da 0.0417
- state_correction_large (dx_l2>3 또는 max|dx|>2): True (dx_l2=2.731, max|dx|=2.382)
